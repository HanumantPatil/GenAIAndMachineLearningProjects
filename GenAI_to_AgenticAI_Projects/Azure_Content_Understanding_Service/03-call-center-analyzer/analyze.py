"""Analyze a customer-service recording with Azure Content Understanding."""
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Transcribe and summarize a call-center recording.")
    parser.add_argument("input_source", help="Local path or public URL of an audio or video file.")
...
def main() -> int:
    ...
    try:
        ...
        print("\n--- Transcript ---\n")
        print(content.markdown or "No transcript was returned.")
        print("\n--- Call Insights ---")
