"""Extract US tax form fields with Azure Content Understanding."""
...
def print_field(name: str, field: ContentField) -> None:
    confidence = f" confidence={field.confidence:.1%}" if field.confidence is not None else ""
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Classify and extract fields from a US tax document.")
    parser.add_argument("input_source", help="Local path or public URL of a US tax form PDF or image.")
...
def main() -> int:
    ...
    try:
        ...
        print(f"Detected tax form: {content.category or 'unknown'}\n")
