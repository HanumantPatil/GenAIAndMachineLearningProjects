...
# Get the directory where this file is located and build paths to artifact files
artifact_dir = Path(__file__).parent / "artifact"

model_rest = load(artifact_dir / "model_rest.joblib")
model_young = load(artifact_dir / "model_young.joblib")

scaler_rest = load(artifact_dir / "scaler_with_cols_rest.joblib")
scaler_young = load(artifact_dir / "scaler_with_cols_young.joblib")
